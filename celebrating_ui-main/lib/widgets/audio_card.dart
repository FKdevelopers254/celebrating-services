...
class _AudioCardState extends State<AudioCard> {
  ...
  List<double> _waveHeights =
      List.generate(30, (i) => Random().nextDouble() * 20 + 10);
      ...
      children: [
        ...
        Expanded(
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text(widget.audioPost.from.fullName,
                  style: const TextStyle(
                      fontWeight: FontWeight.bold, fontSize: 16)),
              Text(widget.audioPost.from.username,
    ...
    return Row(
      ...
      children: [
        ...
        Row(
          children: [
            IconButton(
                icon: const Icon(Icons.repeat_outlined), onPressed: () {}),
  ...
  Widget _buildRatingSection() {
    ...
    final int rating =
        hasRated ? widget.audioPost.initialRating : _currentRating;
                ...
                return GestureDetector(
                  onTap: () {
                    setState(() {
                      ...
                      print(
                          'User rated: $_currentRating stars for post ID: ${widget.audioPost.id}');

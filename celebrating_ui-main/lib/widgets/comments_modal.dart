...
class _CommentsModalState extends State<CommentsModal> {
  ...
  bool _hasText =
      false; // To control the 'Reply' button color and enabled state
  Comment? _replyingTo;
  ...
  void _postComment() async {
    ...
    final User currentUser = User(
      ...
      fullName: 'You',
      profileImageUrl:
          'https://images.unsplash.com/photo-1544005313-94ddf0286df2?q=80&w=200&h=200&fit=crop&auto=format&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
